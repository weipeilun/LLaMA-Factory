...
def autocast_projector_dtype(model: "PreTrainedModel", model_args: "ModelArguments") -> None:
    ...
    if getattr(model, "quantization_method", None):
        ...
        if model_type in ["llava", "llava_next", "llava_next_video", "llava_onevision", "mllama", "paligemma", "video_llava"]:
...
def get_forbidden_modules(config: "PretrainedConfig", finetuning_args: "FinetuningArguments") -> Set[str]:
    ...
    if model_type in ["llava", "llava_next", "llava_next_video", "llava_onevision", "paligemma", "video_llava"]:
